...
export const DashBoardGrid: React.FC<DashBoardGridProps> = ({
  ...
  return (
    <div className="container mx-auto px-10 max-md:px-5 overflow-hidden">
      <h4 className="text-[24px] text-vysyamalaBlackSecondary font-bold mb-5">
        Dashboard
      </h4>

      <div className="space-y-10 mb-10">
        <div className="grid grid-rows-1 grid-cols-2 gap-5 items-center max-lg:grid-cols-1">
          {/* {/ 3 Dashboard Cards /} */}
          <div>
            <div className="grid grid-rows-2 grid-cols-2 gap-5 items-center max-sm:grid-cols-1">
              ...
              <div
                onClick={onDashBoardMatchingProfiles}
                className="relative row-span-2 w-full h-full bg-vysyamalaPink shadow-lg rounded-xl p-5 cursor-pointer z-[1]"
              >
              ...
              <div
                onClick={onDashBoardMutualInterest}
                className="relative w-full h-full bg-vysyamalaViolet rounded-xl shadow-lg p-5 cursor-pointer z-[1]"
              >
                <div className="absolute top-0 bottom-0 right-0 z-[-1]">
                  <img src={VioletLayer} alt="" className="w-full h-full" />
                </div>
              ...
              <div
                onClick={onDashBoardWishlist}
                className="relative w-full bg-vysyamalaYellow rounded-xl shadow-lg p-5 cursor-pointer z-[1]"
              >
                <div className="absolute top-0 bottom-0 right-0 z-[-1]">
                  <img src={YellowLayer} alt="" className="w-full h-full" />
                </div>
          ...
          <div>
            <div className="bg-white rounded-xl shadow-md p-5">
              <div className="flex justify-between items-start mb-5">
                <div className="flex justify-center items-center space-x-5 max-sm:flex-col max-sm:items-start">
                  <div>
                    <img
                      src={dashboardDetails?.profile_details.profile_image}
                      alt="My Profile Image"
              ...
              <div className="bg-vysyamalaLightSandal px-5 py-7 max-sm:px-0">
        ...
        <div className="grid grid-rows-1 grid-cols-2 gap-5 items-center  max-lg:grid-cols-1">
          ...
          {/* {/ My Options /} */}
          <div>
            <div className="grid grid-rows-2 grid-cols-2 gap-5  max-sm:grid-cols-1">
              <IndicatorCard
                onClick={onInterestSent}
                cardTitle="Interest Sent"
                cardCount={String(dashboardDetails?.sent_int_count || 0)}
