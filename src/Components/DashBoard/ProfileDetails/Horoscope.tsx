            ...
            {isEditing ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-10 my-10">
                        <div>
                            <RasiGrid data={formData.personal_rasi_katt || ''} onChange={handleRasiGridChange} centerLabel={"Rasi"} />
                        </div>
                        <div>
                            <AmsamGrid data={formData.personal_amsa_katt || ''} onChange={handleAmsamGridChange} centerLabel={"Amsam"} />
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="space-y-10 my-10">
                        <div>
                            <RasiGrid data={horoscopeDetails.personal_rasi_katt || ''} centerLabel={"Rasi"} onChange={handleRasiGridChange} />
                        </div>
                        <div>
                            <AmsamGrid data={horoscopeDetails.personal_amsa_katt || ''} centerLabel={"Amsam"} onChange={handleAmsamGridChange} />
                        </div>
                    </div>
                </div>
            )}
