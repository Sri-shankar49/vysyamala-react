            ...
            <div className="bg-white w-1/3 rounded-lg container mx-auto">
                <div className="rounded-lg">
                    <div className="bg-secondary rounded-t-lg flex justify-between items-center px-3 py-2 mb-2">
                        <h4 className="text-[24px] text-white font-semibold">Enter your Interest Message</h4>
                        <IoClose onClick={handleCancel} className="text-[22px] text-white cursor-pointer" />
                    </div>
                                    ...
                                    {message.length <= 0 && (
                                        <div>
                                            <select onChange={handleChange} name="" id="" className="w-full px-2 py-2 border-[1px] border-primary rounded-md focus-within:outline-none">
                                                ...
                                                <option value="Horscope matched and I would love to know more about you.">Horscope matched and I would love to know more about you.</option>
                                                <option value="I am interested in knowing more about you">I am interested in knowing more about you</option>
                                                <option value="It seems our stars align. I'm eager to get to know you better"> It seems our stars align. I'm eager to get to know you
                                                    better</option>
                                            </select>
                                        </div>
                                    )}
