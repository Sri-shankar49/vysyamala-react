...
export const OtpVerification: React.FC<OtpVerificationProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="mb-5">
        <h2 className="text-primary text-[24px] font-semibold mb-2 max-md:text-[20px] max-sm:leading-5 max-sm:mb-3">
          Mobile Verification
        </h2>
      ...
      <div className="flex justify-center items-center gap-x-2 mb-8">
        {Array.from({ length: totalInputs }).map((_, index) => (
          <input
            ...
            type="text"
            maxLength={1}
            className={`outline-none px-2 text-primary w-10 h-10 border ${
