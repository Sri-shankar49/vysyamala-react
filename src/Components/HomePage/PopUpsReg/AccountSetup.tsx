...
const schema = zod
  .object({
    ...
    // mobile: zod.string().refine((value) => /^[0-9]{10}$/.test(value), {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div>
        ...
        <h5 className="text-[24px] text-primary font-semibold mb-5 max-md:text-[20px] max-sm:leading-5 max-sm:mb-3">
      ...
      <div className="w-36 flex justify-between items-center mb-5 max-sm:mb-3">
        <div>
          <input
            type="radio"
            id="male"
      ...
      <button
        type="submit"
        className="w-full py-[10px] px-[24px] bg-gradient text-white rounded-[6px] mt-2 max-sm:mt-0"
      ...
      <p className="text-red-500 ml-16">
