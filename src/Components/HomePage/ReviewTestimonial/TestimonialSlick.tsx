...
const TestimonialSlick: React.FC<TestimonialSlickProps> = ({
  ...
  return (
    <div className="bg-white flex flex-col justify-between h-[200px] space-y-8 mx-5 p-6 rounded-md shadow-reviewBoxShadow my-5 max-md:space-y-3 max-md:mx-2 max-sm:h-[200px] max-sm:m-2">
      <div className="">
