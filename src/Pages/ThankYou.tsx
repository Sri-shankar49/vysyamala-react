    ...
    <div className="bg-gray">
      <div className="container bg-white mx-auto rounded-[12px] shadow-md pt-24 pb-32 px-32">
        ...
        <div className="mt-10 grid grid-cols-2 gap-x-5 justify-center items-center">
          <div className="px-8 py-10 border border-gray rounded-xl">
              ...
              <div className="flex-1">
                ...
                <div className="mt-5">
                  <Link to="/ContactDetails">
                    <button className="bg-main text-white px-5 py-2.5 rounded-md">
                      Register Now
                    </button>
                  </Link>
                </div>
          ...
          <div className="px-8 py-10 border border-gray rounded-xl">
            <div className="flex justify-between space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="mt-5">
                  <button className="text-main px-5 py-2.5 border border-main rounded-md">
