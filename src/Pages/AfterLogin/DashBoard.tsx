            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-rows-2 grid-cols-2 gap-5 items-center">
                    ...
                    <div>
                        <div className="grid grid-rows-2 grid-cols-2 gap-5 items-center">
                            {/* Matching Profiles */}
                            <div className="relative row-span-2 w-full h-full bg-vysyamalaPink shadow-lg rounded-xl p-5">
                            ...
                            {/* Mutual Interest */}
                            <div className="relative w-full h-full bg-vysyamalaViolet rounded-xl shadow-lg p-5">
                                <div className="absolute top-0 bottom-0 right-0">
                            ...
                            {/* Wishlist */}
                            <div className="relative w-full bg-vysyamalaYellow rounded-xl shadow-lg p-5">
                                <div className="absolute top-0 bottom-0 right-0">
                    ...
                    {/* My Profile */}
                    <div className="bg-white h-full rounded-xl shadow-md p-5">
