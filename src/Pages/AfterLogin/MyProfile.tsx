...
export const MyProfile = () => {
  ...
  const handleDownloadPdf = () => {
    ...
    link.href = `https://apiupg.rainyseasun.com/auth/generate-pdf/${Get_profile_det_match?.profile_id}`;
  ...
  const percentage = 85;
  console.log(Get_profile_det_match, "Get_profile_det_match");
  return (
    <div>
              ...
              {loading ? (
                ...
                <>
                  <div className="flex justify-between items-center">
                    <div>
                      <h4 className="flex items-center text-[30px] text-secondary font-bold mb-2">
                        ...
                        {Get_profile_det_match.verified === 1 && (
                  ...
                  <p className="text-[20px] text-primary font-bold mb-2">
                    {Get_profile_det_match.profile_id}
                  </p>
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-3">
                        ...
                        <h5 className="text-[18px] text-ash font-semibold">
                          ...
                          <span className="font-normal">
                            {" "}
                            {Get_profile_det_match.height} cms
                          </span>
                        </h5>
                      </div>
                      ...
                      <div className="mb-3">
                        <h5 className="text-[18px] text-ash font-semibold">
                          ...
                          <span className="font-normal">
                            {" "}
                            {Get_profile_det_match.weight} kg
                          </span>
                        </h5>
                      </div>
                      ...
                      <div className="mb-3">
                        <h5 className="text-[18px] text-ash font-semibold">
                          ...
                          <span className="font-normal">
                            {" "}
                            {Get_profile_det_match.profession}
                          </span>
                        </h5>
                      </div>
                      ...
                      <div className="mb-3">
                        <h5 className="text-[18px] text-ash font-semibold">
                          ...
                          <span className="font-normal">
                            {" "}
                            {Get_profile_det_match.education}
                          </span>
                        </h5>
                      </div>
